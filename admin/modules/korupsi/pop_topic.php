...
if (isset($_POST['save']) AND (isset($_POST['topicID']) OR trim($_POST['search_str']))) {
    ...
    if (isset($_POST['biblioID']) AND !empty($_POST['biblioID'])) {
        ...
        if ($sql_op->insert('biblio_topic', $data)) {
            ...
            echo 'parent.setIframeContent(\'topicIframe\', \''.MWB.'korupsi/iframe_topic.php?biblioID='.$data['biblio_id'].'\');';
            echo '</script>';
        } else {
        ...
        echo 'parent.setIframeContent(\'topicIframe\', \''.MWB.'korupsi/iframe_topic.php\');';
        echo '</script>';
    }
}
