...
<div class="menuBoxInner statisticIcon">
	<div class="per_title">
	  <h2><?php echo __('Publikasi Lokal Report Per Book'); ?></h2>
  </div>
	<!-- <div class="infoBox">
...
<script type="text/javascript">
  ...
  function lb_detail() {
    $.ajax({
      type : 'POST',
      url : '<?php echo MWB; ?>korupsi/lb_data_detil.php',
      data :{
        'biblio_id' : biblio_id,
        'tgl_awal' : tgl_awal,
        'tgl_akhir' : tgl_akhir,
  ...
  function lb() {
    $.ajax({
      type : 'POST',
      url : '<?php echo MWB; ?>korupsi/lb_data_index.php',
      data : {
        'cari' : cari,
        'urut' : urut,
        'tgl_awal' : tgl_awal,
  ...
  function lbp() {
    $.ajax({
      type : 'POST',
      url : '<?php echo MWB; ?>korupsi/lb_data_paging.php',
      data :{
        'cari' : cari,
        'urut' : urut,
        'tgl_awal' : tgl_awal,
...
var url = "<?php echo MWB.'korupsi/lb_excel.php';?>";
/* */	
var $iframe,
      iframe_doc,
      iframe_html;
