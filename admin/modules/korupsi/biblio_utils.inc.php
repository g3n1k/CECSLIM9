...
function showTitleAuthors($obj_db, $array_data)
{
    ...
    if (true) {
        $_sql_biblio_q = sprintf('SELECT b.title, a.author_name, opac_hide, promoted, b.labels FROM korupsi AS b
            LEFT JOIN korupsi_author AS ba ON b.biblio_id=ba.biblio_id
