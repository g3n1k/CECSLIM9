...
if (isset($_POST['remove'])) {
    ...
    $sql_op->delete('korupsi_author', 'author_id='.$id.' AND biblio_id='.$bid);
    echo '<script type="text/javascript">';
...
if ($biblioID) {
    ...
    // database list
    $biblio_author_q = $dbs->query("SELECT ba.*, a.author_name, a.author_year, a.authority_type FROM korupsi_author AS ba
