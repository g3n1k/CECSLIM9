  ...
  <?php if (isset($_GET['h'])): ?>
    ...
    <?php
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-xs-12 right xs-center">
                                <div class="social">
                                  ...
                                  <a href="http://www.digg.com/submit?url=<?php echo 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?>" target="_blank">
                                  ...
                                  <a href="http://reddit.com/submit?url=<?php echo 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?>" target="_blank">
      ...
      <?php } elseif ($_GET['h'] == 'show_detail') {
        ...
        $query_jml_pengunjung = "SELECT FROM pengunjung WHERE biblio_id = '$id' AND type = '0'";
                    ...
                    <div class="col-md-12">
                        <div class="center-loop-fade">
                          ...
                          $query_terbaru = "SELECT biblio.biblio_id as biblio_id,
                                            ...
                                            ((SELECT COUNT(*) FROM pengunjung WHERE pengunjung.biblio_id = biblio.biblio_id) + (SELECT COUNT(*) FROM baca WHERE baca.biblio_id = biblio.biblio_id) + (SELECT COUNT(*) FROM loan WHERE loan.item_code = item.item_code)) as total
                                            FROM biblio
          ...
          <div class="col-md-12">
            ...
            <div class="col-md-12">
              ...
              <p class="footer-text" style="width:100%">
                <span class="pull-right" style="font-size:12px;color:black;">
                  <center>
