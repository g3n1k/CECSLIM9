    $(function() {
        ...
        $('#c_logos .slide, .logo-slider').owlCarousel({
            ...
            dots : false,
            nav: true,
            navText : ["<i class='ion-ios-arrow-left kiri'></i>","<i class='ion-ios-arrow-right kanan'></i>"],
            autoplay: false,
...
$(document).ready(function(){
	...
	// if in newsletter page
	$('#newsletter_slc_year').change(function() {
        	var _y = $(this).val();
        	var _url = $('#encoded_url').val();
        	window.open(_url+_y,"_self")
    	});
	
	// reset value form if in show_detail/contact page
	$('#form-name').val('');
	$('#form-email').val('');
	$('#form-textarea').val('');
	$('#form-captcha').val('');
