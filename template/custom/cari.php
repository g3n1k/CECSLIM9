...
MATCH (biblio.title, biblio.call_number) AGAINST ('".$_p['kata']."' IN NATURAL LANGUAGE MODE) as score
FROM biblio
...
MATCH (biblio.title, biblio.call_number) AGAINST ('".$_p['kata']."' IN NATURAL LANGUAGE MODE) OR
