<nav class="s-menu-content animated-fast" role="navigation">
  ...
  <ul>
    ...
    <li class="menu-nya"><a href="javascript:void(0)"><?php echo __('Collections'); ?></a></li>
    <section class="sub-menu" style="display:none;">
      <li>&nbsp;&nbsp;&nbsp; <small><a href="index.php?title=korupsi+OR+corruption&subject=korupsi+OR+corruption&search=Search"><?php echo __('Corruptions Collections'); ?></a></small></li>
      <li>&nbsp;&nbsp;&nbsp; <small><a href="index.php?p=local"><?php echo __('Local University Publish'); ?></a></small></li>
    </section>
    ...
    <li style="display:none;"><a href="index.php?p=slimsinfo"><?php echo __('About SLiMS'); ?></a></li>
  </ul>
...
<script type="text/javascript">
  $(document).on('click','.menu-nya',function() {
